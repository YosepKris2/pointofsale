...
<head>
	...
	<title>PT.Troya Digital Mesail | Dashboard</title>
	<link rel="icon" href="<?= base_url() ?>assets/images/Troya Digital.png" type="image/png">
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="index2.html" class="logo">
				...
				<span class="logo-lg"><b>PT.Troya Digital Mesail</b></span>
			</a>
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									...
									<p>
										...
										<small>Anggota Sejak April 2024</small>
									</p>
								</li>
								<!-- Menu Body -->
								<li class="user-body">
					...
					<ul class="sidebar-menu" data-widget="tree">
						...
						<li class="active treeview">
							...
							<ul class="treeview-menu">
								<li class="active"><a href="<?php echo base_url() ?>index.php/produk"><i class="fa fa-circle-o"></i>PRODUK</a></li>
							</ul>
						</li>
						<li>
						...
						<li class="active treeview">
							...
							<ul class="treeview-menu">
								...
								<li><a href="<?php echo base_url() ?>index.php/lapsales"><i class="fa fa-circle-o"></i>LAPORAN PENJUALAN SALES</a></li>
							</ul>
						</li>
					</ul>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2024 <a href="#">PT. Troya Digital Mesail</a>.</strong> All rights
			reserved.
		</footer>
		<!-- /.control-sidebar -->
	...
	<!- - Bootstrap WYSIHTML5 -->
		...
		<!-- Slimscroll -->
		<script src="<?php echo base_url() ?>assets/bower_components/jquery-slimscroll/jquery.slimscroll.min.js">
		</script>
		<!-- FastClick -->
